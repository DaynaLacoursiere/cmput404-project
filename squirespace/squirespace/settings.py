"""
Django settings for squirespace project.
...
SECRET_KEY = 'cj48+f=8*)nmoo&6^tz*56xfzqw5l#s!_)p(jt9k40cluje$l3'
...
WSGI_APPLICATION = 'squirespace.wsgi.application'
