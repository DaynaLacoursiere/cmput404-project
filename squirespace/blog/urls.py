...
urlpatterns = [
	...
	url(r'^profile/(?P<pk>[\w-]+)/friend_request_sent/$', views.send_friend_request, name='send_friend_request'),
	url(r'^profile/(?P<pk>[\w-]+)/friend_request_cancelled/$', views.cancel_friend_request, name='cancel_friend_request'),
	url(r'^profile/(?P<pk>[\w-]+)/friend_request_accepted/$', views.accept_friend_request, name='accept_friend_request'),
	url(r'^profile/(?P<pk>[\w-]+)/friend_request_rejected/$', views.reject_friend_request, name='remove_friend'),
	url(r'^profile/(?P<pk>[\w-]+)/friend_removed/$', views.remove_friend, name='remove_friend'),
